...
pub fn ui_new_room<B: Backend>(frame: &mut Frame<B>, input: Input, msg: String) {
    ...
    let button_rect = rect_cut_center(chunks[2], -3, 24);
    frame.render_widget(get_button("Create Room!", true), button_rect);
}
